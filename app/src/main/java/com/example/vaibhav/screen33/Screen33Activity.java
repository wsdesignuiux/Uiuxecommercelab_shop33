package com.example.vaibhav.screen33;
...
public class Screen33Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.dot1:
                img1.setImageResource(R.drawable.ic_ic_radiobutton_blue);
            ...
            case R.id.dot2:
                ...
                img2.setImageResource(R.drawable.ic_ic_radiobutton_blue);
                img3.setImageResource(R.drawable.circle_gray);
                img4.setImageResource(R.drawable.circle_darkgray);
                img5.setImageResource(R.drawable.circle_gray);
                img6.setImageResource(R.drawable.circle_darkgray);
            ...
            case R.id.dot3:
                img1.setImageResource(R.drawable.circle_gray);
                img2.setImageResource(R.drawable.circle_darkgray);
                img3.setImageResource(R.drawable.ic_ic_radiobutton_blue);
                img4.setImageResource(R.drawable.circle_darkgray);
                img5.setImageResource(R.drawable.circle_gray);
                img6.setImageResource(R.drawable.circle_darkgray);
                break;
            ...
            case R.id.dot4:
                ...
                img2.setImageResource(R.drawable.circle_darkgray);
                img3.setImageResource(R.drawable.circle_gray);
                img4.setImageResource(R.drawable.ic_ic_radiobutton_blue);
                img5.setImageResource(R.drawable.circle_gray);
                img6.setImageResource(R.drawable.circle_darkgray);
                break;
            ...
            case R.id.dot5:
                ...
                img3.setImageResource(R.drawable.circle_gray);
                img4.setImageResource(R.drawable.circle_darkgray);
                img5.setImageResource(R.drawable.ic_ic_radiobutton_blue);
                img6.setImageResource(R.drawable.circle_darkgray);
                break;
            ...
            case R.id.dot6:
                ...
                img4.setImageResource(R.drawable.circle_darkgray);
                img5.setImageResource(R.drawable.circle_gray);
                img6.setImageResource(R.drawable.ic_ic_radiobutton_blue);
                break;
